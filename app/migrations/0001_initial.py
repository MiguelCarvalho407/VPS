# Generated by Django 5.1.5 on 2025-07-17 16:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_treino', models.CharField(choices=[('mobilidade', 'Mobilidade'), ('força', 'Força'), ('funcional', 'Funcional'), ('metabólico', 'Metabólico')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regime', models.CharField(blank=True, choices=[('regime_livre', 'Regime Livre'), ('regime_basico', 'Regime Básico')], default='regime_livre', max_length=20, null=True)),
                ...
                ('como_teve_conhecimento_existencia_fitclub', models.CharField(choices=[('atraves_familiares', 'Através de Familiares'), ('atraves_amigos', 'Através de Amigos'), ('atraves_panfleto', 'Através de Panfleto/Cartaz'), ('atraves_facebook', 'Através de Página Facebook'), ('atraves_instagram', 'Através de Instagram'), ('atraves_whatsapp', 'Através de Grupo WhatsApp')], default='Por Definir', max_length=100)),
